...
**Other Skills:** Leadership, Problem Solving, Mentorship, Communication  
...
**LeetCode Data Web (2025)** — Web app to visualize and analyze LeetCode problem-solving data  
**Indian Map (2025)** — Interactive state map using D3.js + React  
**Theme Clock (2025)** — Customizable digital clock with animations  
**Hacktoberfest Contributor (2025)** — Open-source contributions and PRs  

---

## 🌱 Community & Mentorship

- Google Student Ambassador (Jul 2025–Present)  
- Organized 5+ campus tech events  
- Mentorship programs for student developers  
