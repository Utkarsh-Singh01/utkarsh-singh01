...
### MERN Stack Developer | Open-Source Contributor | Hackathon Enthusiast

💻 I build interactive, scalable web apps using **React, Node.js, MongoDB, and JavaScript**.  
...
| ------- | ----------- | ---------- | ---- |
| LeetCode Data Web | Web app to visualize LeetCode problem-solving data | React, JS | [Live](https://utkarsh-singh01.github.io/LeetCode-Data/) |
| Indian Map | Interactive state map with tooltips | D3.js, React | [GitHub](https://github.com/utkarsh-singh01/Indian-Map) |
| Theme Clock | Customizable digital clock with themes & animations | HTML, CSS, JS | [GitHub](https://github.com/utkarsh-singh01/Theme-Clock) |
...
![Contribution Graph](https://ghchart.rshah.org/utkarsh-singh01)
...
**Certifications:**  
- Google AI (2025)  
- TCS iON Young Professional (2025)  
